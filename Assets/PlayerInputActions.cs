    ...
    ""maps"": [
        {
            ...
            ""id"": ""35bfd76e-d57a-4370-9ba6-b121316445c6"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""PassThrough"",
                    ""id"": ""4b6695a4-0dfc-4c35-81c0-ace409539ae7"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""afea20ce-0d58-4ff6-ae02-aa07468cc63e"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Crouch"",
                    ""type"": ""Button"",
                    ""id"": ""5e326af4-ac8d-4291-b07f-36041053e0fc"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                ...
                },
                {
                    ""name"": ""Attack"",
                    ""type"": ""Button"",
                    ""id"": ""d11028d7-f865-464b-986e-1170bbf4068d"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": ""AD"",
                    ""id"": ""769ef6e3-925a-42ba-8385-3f889654d1cf"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""c4004e23-aae7-4872-a1d3-adac8069b96f"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""9daf282f-181c-4b7d-b9f1-46e9deff7ec2"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""51b480a9-e415-4f78-a710-6f3200545ddd"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""31f5803e-c103-40bd-8889-9b83e6e5b1b1"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""700917c9-8326-4337-b409-73a7fdcec2fa"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""cf101973-52d3-43f0-b496-5f0f3e80d891"",
